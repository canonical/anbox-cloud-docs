...
In the 1.30.0 release, Anbox Cloud introduced virtualized AAOS images with AAOS 16. These images are also available for later supported AAOS versions and provide native gRPC support for the vehicle HAL. See {ref}`exp-android-execution-models` for details on the virtualized Android execution model.
