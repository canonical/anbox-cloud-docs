---
html_meta:
  description: Anbox runtime security in Anbox Cloud. The Anbox runtime uses cryptographic
    technology for all HTTP communication over IP connections and for securing data
