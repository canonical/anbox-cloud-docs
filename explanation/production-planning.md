...
You should also assess the number of instances that you require for each model/service. For example, think about the number of Juju controller instances that you need. See [Make a controller highly available](https://documentation.ubuntu.com/juju/3.6/howto/manage-controllers/#make-a-controller-highly-available) for more information.
