---
html_meta:
  description: Instances are the center piece of the Anbox Cloud stack. Every time
    you launch an application or an image, Anbox Cloud creates an instance for it.
---
(exp-instances)=
# Instances
