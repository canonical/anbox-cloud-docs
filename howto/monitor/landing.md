...
The output will list a `metrics.url` field which provides you the URL. The output will also provide a TLS certificate the endpoint the URL points to is using to establish a secure and authenticated connection.
