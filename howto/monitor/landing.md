...
In order to collect and access metrics with a charmed deployment of Anbox Cloud you need to have the [Canonical Observability Stack (COS)](https://charmhub.io/topics/canonical-observability-stack) installed. Anbox Cloud provides necessary integration with COS through the use of the [Grafana Agent charm](https://charmhub.io/grafana-agent). Grafana Agent will scrape the Prometheus endpoints of the Anbox Cloud services and send collected metrics to COS.
