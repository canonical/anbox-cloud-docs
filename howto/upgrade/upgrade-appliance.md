...
The upgrade process for the Anbox Cloud Appliance is straightforward. The primary step is updating the snap package to the appropriate channel. Please note that downgrades are not supported.
