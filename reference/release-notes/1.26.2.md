...
orphan: true
html_meta:
  description: 1.26.2. These release notes cover new changes and bug fixes in Anbox
    Cloud 1.26.2. Anbox Cloud 1.26.2 is a patch release. To understand minor and patch.
---
# 1.26.2
