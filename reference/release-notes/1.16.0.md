...
orphan: true
html_meta:
  description: 1.16.0. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.16.0. Please see the for a list of updated components. Google officially.
---
# 1.16.0
