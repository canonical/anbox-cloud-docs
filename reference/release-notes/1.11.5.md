...
orphan: true
html_meta:
  description: 1.11.5. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.11.5. This release prepares for an upcoming Ubuntu kernel release
    on AWS. With.
---
# 1.11.5
