...
orphan: true
html_meta:
  description: 1.21.1. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.21.1. Please see for a list of updated components. Improved detection
    of.
---
# 1.21.1
