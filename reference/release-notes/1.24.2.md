...
orphan: true
html_meta:
  description: 1.24.2. These release notes cover new features and changes in Anbox
    Cloud 1.24.2. Anbox Cloud 1.24.2 is a patch release. To understand minor and patch.
---
# 1.24.2
