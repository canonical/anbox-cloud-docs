...
orphan: true
html_meta:
  description: 1.20.1. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.20.1. Please see for a list of updated components. A new command
    is available.
---
# 1.20.1
