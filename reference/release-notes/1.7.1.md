...
orphan: true
html_meta:
  description: 1.7.1. The Anbox Cloud team is pleased to announce the release of Anbox
    Cloud 1.7.1 Switched to LLVMpipe based software rendering in favor of swiftshader
    to.
---
# 1.7.1
