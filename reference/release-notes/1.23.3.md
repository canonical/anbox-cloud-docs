...
orphan: true
html_meta:
  description: 1.23.3. This release is specifically for fixing an issue where an unusually
    high GPU memory consumption by an Anbox process was reported. The main trigger
    for.
---
# 1.23.3
