...
orphan: true
html_meta:
  description: 1.17.2. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.17.2. Please see for a list of updated components. The security
    patch level is.
---
# 1.17.2
