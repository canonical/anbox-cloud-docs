...
orphan: true
html_meta:
  description: 1.29.0. These release notes cover new features and changes in Anbox
    Cloud 1.29.0. Anbox Cloud 1.29.0 is a minor release. To understand minor and patch.
---
# 1.29.0
...
Also following this change, the base for Anbox Cloud deployment has been upgraded to Ubuntu 24.04.
