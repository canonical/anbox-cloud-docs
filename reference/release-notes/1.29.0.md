...
* The Android WebView has been updated to [145.0.7632.26](https://chromereleases.googleblog.com/2025/01/chrome-for-android-update_21.html).
* The WebRTC version has been updated to [7499](https://chromium.googlesource.com/chromium/src.git/+log/refs/branch-heads/7499).
* Starting with this release, NVIDIA driver series 580 is required for Anbox Cloud deployments that include NVIDIA GPUs.
