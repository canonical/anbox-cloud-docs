...
* Starting with this release, [NVIDIA driver series 580](https://documentation.ubuntu.com/anbox-cloud/en/latest/reference/requirements) is required for Anbox Cloud deployments that include NVIDIA GPUs.
