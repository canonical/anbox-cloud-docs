...
orphan: true
html_meta:
  description: 1.16.1. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.16.1. Please see the for a list of updated components. Included
    Android.
---
# 1.16.1
