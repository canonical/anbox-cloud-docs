...
orphan: true
html_meta:
  description: 1.5.0 (April 2020). Support for Android 10 including latest security
    updates Updated software rendering to work on Android 10 Applications can now
    have encoder.
---
# 1.5.0 (April 2020)
