...
orphan: true
html_meta:
  description: 1.2.1 (April 2019). Telegraf was restarted every five minutes which
    caused metrics from Anbox being lost. Android framework crashed in ) Application
    updates.
---
# 1.2.1 (April 2019)
