...
orphan: true
html_meta:
  description: 1.3 (January 2020). Generating thumbnails within in the Android 7 images
    is now working reliable where it was generating single colored images at times
    before.
---
# 1.3 (January 2020)
