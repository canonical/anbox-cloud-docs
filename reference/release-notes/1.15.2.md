...
orphan: true
html_meta:
  description: 1.15.2. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.15.2. Please see for a list of updated components. Included Android
    security.
---
# 1.15.2
