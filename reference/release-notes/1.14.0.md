...
orphan: true
html_meta:
  description: 1.14.0. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.14.0. Please see for a list of updated components. All charms that
    are part of.
---
# 1.14.0
