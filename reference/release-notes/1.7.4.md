...
orphan: true
html_meta:
  description: 1.7.4. The Anbox Cloud team is pleased to announce the release of Anbox
    Cloud 1.7.4 Android security fixes from October 2020 (patch level , see here for
    more.
---
# 1.7.4
