...
orphan: true
html_meta:
  description: 1.20.2. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.20.2. Please see for a list of updated components. VPU slots for
    an app are.
---
# 1.20.2
