...
orphan: true
html_meta:
  description: 1.16.3. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.16.3. This release updates only the Anbox Cloud Appliance. However,
    if you run.
---
# 1.16.3
