...
orphan: true
html_meta:
  description: 1.22.1. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.22.1. Please see for a list of updated components. Android security
    updates.
---
# 1.22.1
