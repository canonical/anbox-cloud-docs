...
orphan: true
html_meta:
  description: 1.3.1 (September 2019). Allow underlying image of an application to
    be changed An Anbox platform can now specify the display refresh rate Integrated
    Android.
---
