...
orphan: true
html_meta:
  description: 1.23.1. These release notes cover new features and changes in Anbox
    Cloud 1.23.1. Anbox Cloud 1.23.1 is a patch release. To understand minor and patch.
---
# 1.23.1
