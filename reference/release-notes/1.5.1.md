...
orphan: true
html_meta:
  description: 1.5.1 (May 2020). Fix timeout issue when adding or removing LXD nodes
    from the cluster in AMS Containers are now gracefully terminated to ensure the
    backup.
---
# 1.5.1 (May 2020)
