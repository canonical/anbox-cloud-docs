...
orphan: true
html_meta:
  description: 1.6.0 (June 2020). Watchdog can now be disabled via the application
    manifest or configured to allow additional packages to provide a foreground activity.
---
# 1.6.0 (June 2020)
