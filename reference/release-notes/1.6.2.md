...
orphan: true
html_meta:
  description: '1.6.2 (June 2020). Applications without an APK can now specify a boot
    activity in their application manifest LP #1885107: Automatic application updates
    were.'
---
# 1.6.2 (June 2020)
