...
orphan: true
html_meta:
  description: 1.22.0. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.22.0. Please see for a list of updated components. The 1.22.0 release
    of Anbox.
---
# 1.22.0
