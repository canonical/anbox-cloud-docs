...
orphan: true
html_meta:
  description: 1.9.2. The Anbox Cloud team is pleased to announce the release of Anbox
    Cloud 1.9.2. Please see for a list of updated components. Stability and reliability.
---
# 1.9.2
