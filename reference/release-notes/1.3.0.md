...
orphan: true
html_meta:
  description: 1.3.0 (August 2019). Images are now only distributed via the official
    image server and no longer available for download The application registry received
    a.
---
# 1.3.0 (August 2019)
