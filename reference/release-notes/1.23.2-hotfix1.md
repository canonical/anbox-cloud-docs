...
orphan: true
html_meta:
  description: '1.23.2 hotfix 1. These release notes are for a hotfix release for
    Anbox Cloud 1.23.2 to work around the LP #2083961 bug in snapd. The only updated
    component is.'
---
# 1.23.2 hotfix 1
