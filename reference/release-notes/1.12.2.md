...
orphan: true
html_meta:
  description: 1.12.2. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.12.2. Please see for a list of updated components. Anbox container
    termination.
---
# 1.12.2
