...
The {ref}`stream controls bar <ref-stream-controls-bar>` in the dashboard has been redesigned and expanded. In addition to the existing actions, the following new controls have been added:
