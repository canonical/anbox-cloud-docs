...
orphan: true
html_meta:
  description: 1.19.2. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.19.2. Please see for a list of updated components. When the Anbox
    Cloud.
---
# 1.19.2
