...
orphan: true
html_meta:
  description: 1.12.0. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.12.0. Please see for a list of updated components. Google has released
    the.
---
# 1.12.0
