...
orphan: true
html_meta:
  description: 1.12.4. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.12.4. Please see for a list of updated components. This is a bug
    fix release.
---
# 1.12.4
