...
orphan: true
html_meta:
  description: 1.20.0. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.20.0. Please see for a list of updated components. Anbox Cloud has
    introduced.
---
# 1.20.0
