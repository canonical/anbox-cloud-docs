...
orphan: true
html_meta:
  description: 1.2.0 (April 2019). Updated Android 7.x with all security patches as
    of Mar 5 2019 If configured, images will now be automatically pulled from a Canonical.
---
# 1.2.0 (April 2019)
