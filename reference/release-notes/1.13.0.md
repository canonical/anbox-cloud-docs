...
orphan: true
html_meta:
  description: 1.13.0. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.13.0. Please see for a list of updated components. After supporting
    only.
---
# 1.13.0
