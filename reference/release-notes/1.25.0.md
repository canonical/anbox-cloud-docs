...
orphan: true
html_meta:
  description: 1.25.0. These release notes cover new features and changes in Anbox
    Cloud 1.25.0. Anbox Cloud 1.25.0 is a minor release. To understand minor and patch.
---
# 1.25.0
