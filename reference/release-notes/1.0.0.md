...
orphan: true
html_meta:
  description: 1.0.0 (November 2018). First official stable release of the Anbox Cloud
    stack Simple deployment via Juju in a single command on any cloud (public, private
    or.
---
# 1.0.0 (November 2018)
