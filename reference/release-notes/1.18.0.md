...
orphan: true
html_meta:
  description: 1.18.0. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.18.0. Please see for a list of updated components. The Streaming
    SDK now.
---
# 1.18.0
