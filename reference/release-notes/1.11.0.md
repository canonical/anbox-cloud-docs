...
orphan: true
html_meta:
  description: 1.11.0. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.11.0. Please see for a list of updated components. Allowing users
    to build.
---
# 1.11.0
