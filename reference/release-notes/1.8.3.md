...
orphan: true
html_meta:
  description: 1.8.3. The Anbox Cloud team is pleased to announce the release of Anbox
    Cloud 1.8.3. Android security fixes from January 2021 (patch level , see here
    for more.
---
# 1.8.3
