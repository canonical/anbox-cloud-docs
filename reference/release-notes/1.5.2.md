...
orphan: true
html_meta:
  description: 1.5.2 (June 2020). Fix infinite loading screen issue when streaming
    from Anbox Stream Gateway UI Fix SDK documentation for Anbox Stream Gateway and
    all API.
---
# 1.5.2 (June 2020)
