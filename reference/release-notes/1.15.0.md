...
orphan: true
html_meta:
  description: 1.15.0. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.15.0. Please see for a list of updated components. All snaps are
    now based on.
---
# 1.15.0
