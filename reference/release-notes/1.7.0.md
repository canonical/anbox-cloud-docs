...
orphan: true
html_meta:
  description: 1.7.0 (August 2020). Anbox Cloud is now fully integrated with Ubuntu
    Advantage TLS certificates are now managed through a common CA for all components.
---
# 1.7.0 (August 2020)
