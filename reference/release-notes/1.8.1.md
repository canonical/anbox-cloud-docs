...
orphan: true
html_meta:
  description: 1.8.1. The Anbox Cloud team is pleased to announce the release of Anbox
    Cloud 1.8.1. Android security fixes from November 2020 (patch level , see here
    for more.
---
# 1.8.1
