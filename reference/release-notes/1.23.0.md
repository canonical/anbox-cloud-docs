...
orphan: true
html_meta:
  description: 1.23.0. The Anbox Cloud team is pleased to announce the release of
    Anbox Cloud 1.23.0. Please see component versions for a list of updated components.
    The.
---
# 1.23.0
