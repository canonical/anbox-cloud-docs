...
orphan: true
html_meta:
  description: 1.8.0. The Anbox Cloud team is pleased to announce the release of Anbox
    Cloud 1.8.0. Camera can now be provided with video and static images as content
    via the.
---
# 1.8.0
